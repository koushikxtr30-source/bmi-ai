      ...
      <div className="bg-card border border-border rounded-2xl shadow-2xl p-4 flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex gap-2 mt-3">
            <button onClick={handleInstall} className="flex-1 h-8 rounded-lg bg-primary text-primary-foreground text-xs font-semibold hover:bg-primary/90 transition-colors">Install</button>
            <button onClick={handleDismiss} className="h-8 px-3 rounded-lg border border-border text-xs text-muted-foreground hover:bg-secondary transition-colors">Not now</button>
          </div>
        </div>
      </div>
    </div>
