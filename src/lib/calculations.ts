import type {
  SharedInputs, UnitSystem, ActivityLevel,
  BMICategory, BMIResult, BMRResult, TDEEResult, BodyFatResult, Dashboard,
} from '@/types'
...
export function calculateDashboard(
  ...
  const bmiResult: BMIResult = {
    bmi: bmiVal, category: bmiCat, label: bmiLabel,
    color: bmiColor, tip: bmiTip,
    idealWeightMin: idealMin, idealWeightMax: idealMax,
  }
